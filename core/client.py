...
from core.exceptions import ShortURLAPIError, ShortURLAuthError, ShortURLError, ShortURLTimeoutError
...
class ShortURLClient:
    ...
    def _handle_error_response(self, response: httpx.Response) -> None:
        ...
        if status in (401, 403):
            raise ShortURLAuthError(message)
        raise ShortURLAPIError(message=message, code=code, status_code=status)
