"""Configuration management for MCP ShortURL server."""
...
class Settings:
    ...
    request_timeout: float = field(
        default_factory=lambda: float(os.getenv("SHORTURL_REQUEST_TIMEOUT", "30"))
    )

    # Server Configuration
    server_name: str = field(default_factory=lambda: os.getenv("MCP_SERVER_NAME", "shorturl"))
